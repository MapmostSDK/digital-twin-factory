...
<template>
  <div class="ly-left">
    <div class="baseBoxLeft left">
      <div class="boxTitle">
        <img
          src="../assets/images/equipment_management.png"
          style="width: 35px"
        />
        <label class="title">设备管理</label>
      </div>
      <img src="../assets/images/left.png" class="first_border" alt="" />
      <div class="firstBox">
        <div class="first-line">
          <div class="first-unit">
            <img
              src="../assets/images/process_equipment.png"
              style="width: 60px"
            />
          ...
          <div class="second-unit">
            <img
              src="../assets/images/storage_equipment.png"
              style="width: 60px"
            />
            <div class="equip-text">
        ...
        <div class="second-line">
          <div class="first-unit">
            <img
              src="../assets/images/machinery_equipment.png"
              style="width: 60px"
            />
            <div class="equip-text">
          ...
          <div class="second-unit">
            <img
              src="../assets/images/safety_equipment.png"
              style="width: 60px"
            />
            <div class="equip-text">
        ...
        <div class="progress">
          ...
          <img src="../assets/images/progress.gif" alt="" />
        </div>
      </div>
    </div>
  </div>
